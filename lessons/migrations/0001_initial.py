# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-04 04:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='shop',
            name='tutor',
            field=models.ManyToManyField(related_name='tutor', to='lessons.Tutor'),
        ),
        migrations.AddField(
            model_name='event',
            name='location',
        ...
        migrations.AddField(
            model_name='user',
            name='location',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_location', to='lessons.Location'),
        ),
        migrations.AddField(
            model_name='user',
