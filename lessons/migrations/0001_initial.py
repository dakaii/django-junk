# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-04-09 07:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking_place', to='lessons.Area')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
        ...
        migrations.AddField(
            model_name='booking',
            name='lesson',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking_lesson', to='lessons.Lesson'),
        ),
        migrations.AddField(
            model_name='booking',
            name='user',
